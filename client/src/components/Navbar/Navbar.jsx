                    ...
                    <div className="container-fluid px-0 px-md-4">
                        ...
                        <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
                            <div className="navbar-nav me-auto">
                                <Link
                                    className={`nav-link nav-link-container d-flex justify-content-between align-items-center nav-first-child ${isActive("/")}`}
                                    to="/"
                                >
                                    <span>Home</span>
                                ...
                                <Link
                                    className={`nav-link nav-link-container d-flex justify-content-between align-items-center ${isActive("/about")}`}
                                    to="/about"
                                >
                                    <span>About</span>
                                    <span className="material-symbols-outlined pe-3">
                                ...
                                <Link
                                    className={`nav-link nav-link-container d-flex justify-content-between align-items-center ${isActive("/services")}`}
                                    to="/services"
                                >
                                    <span>Services</span>
                                    <span className="material-symbols-outlined pe-3">
                                ...
                                <Link
                                    className={`nav-link nav-link-container d-flex justify-content-between align-items-center ${isActive("/testimonials")}`}
                                    to="/testimonials"
                                >
                                ...
                                <Link
                                    className={`nav-link nav-link-container d-flex justify-content-between align-items-center nav-last-child ${isActive("/contact")}`}
                                    to="/contact"
                                >
                                    <span>Contact</span>
                                    <span className="material-symbols-outlined pe-3">
                    ...
                    <div className="container px-0 px-md-4">
                        ...
                        <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
                            <div className="navbar-nav me-auto gap-3">
                                ...
                                <Link className={`nav-link ${isActive("/testimonials")}`} to="/testimonials">Testimonials</Link>
